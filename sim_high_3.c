...
#define n_dist 10
#define n_msg 3	// number of message generated 1, 2, 4, 8, 16
#define n_lane 4
#define iter 100
...
{
	//Printout to file
	FILE* nhopFile = fopen ("nhopFile_high_3.tr", "a+");
	FILE* collisionFile = fopen("collisionFile_high_3.tr", "a+");
	FILE* propDelayFile = fopen("nslotFile_high_3.tr","a+");
